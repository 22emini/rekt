...
const Contact = () => {
  return (
    <div className="relative w-full min-h-[80vh] bg-[#8A38F5] flex flex-col items-center justify-between py-16 px-8 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl gap-8 flex-1">
        ...
        <div className="flex-1 flex flex-col items-center">
          ...
          <div className="mb-6 bg-white rounded-full p-3 shadow-2xl border-4 border-[#6C2298]">
            <Image 
          ...
          <div className="flex gap-4 mb-8">
            ...
            <a
              href="#"
              className="w-12 h-12 md:w-14 md:h-14 bg-white border-2 border-[#6C2298] rounded-full flex items-center justify-center hover:bg-gray-100 transition shadow-lg"
            >
      ...
      <div className="relative z-20 w-full max-w-5xl">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 bg-[#6C2298]/80 border-2 border-white rounded-full px-6 md:px-8 py-3 md:py-4">
          
          {/* Navigation Links */}
          <nav className="flex items-center gap-4 md:gap-6" style={{ fontFamily: "Impact, 'Arial Black', sans-serif" }}>
            <a href="#about" className="text-white font-bold text-xs md:text-sm tracking-wider hover:opacity-80 transition uppercase">
              ABOUT
            </a>
            <a href="#story" className="text-white font-bold text-xs md:text-sm tracking-wider hover:opacity-80 transition uppercase">
              STORY
            </a>
            <a href="#tokenomics" className="text-white font-bold text-xs md:text-sm tracking-wider hover:opacity-80 transition uppercase">
              TOKENOMICS
            </a>
            <a href="#how-to-buy" className="text-white font-bold text-xs md:text-sm tracking-wider hover:opacity-80 transition uppercase">
              HOW TO BUY
            </a>
          </nav>

          {/* Buy Button */}
          <button className="px-5 md:px-6 py-2 border-2 bg-[#6C2298] border-white rounded-full text-white font-bold text-xs md:text-sm tracking-wider hover:bg-white hover:text-purple-900 transition uppercase" style={{ fontFamily: "Impact, 'Arial Black', sans-serif" }}>
            BUY REKT
          </button>
        </div>
      </div>
